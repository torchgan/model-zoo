...
parser.add_argument("-losses", help="List of losses for training", default="MinimaxGeneratorLoss MinimaxDiscriminatorLoss")
...
losses_list = [getattr(losses,loss)() for loss in args.losses.split(" ")]
trainer = Trainer(network_params, optim_params, losses_list, sample_size=64, epochs=20)
